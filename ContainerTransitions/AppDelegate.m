...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.privateWindow.rootViewController
...
-(NSArray*)_configuredRootViewControllers
{
  ...
  @{@"title": @"Third",@"color": [UIColor colorWithRed:1 green:0.8f blue:0.4f alpha:1]}];
    ...
    for(NSDictionary * configuration in configurations){
        ...
        childViewController.title = configurations[@"title"];
        childViewController.t
    }
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "skyme.ContainerTransitions" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ContainerTransitions" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ContainerTransitions.sqlite"];
    NSError *error = nil;
